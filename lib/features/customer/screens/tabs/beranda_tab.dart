...
class BerandaTab extends StatelessWidget {
  ...
  Widget _buildWalletDropdown(BuildContext context) {
    ...
    final String currentBranchName =
        activeWallet!['branches']?['nama_cabang'] ?? 'Cabang';
                    ...
                    Flexible(
                      ...
                      child: Text(
                        ...
                        overflow: TextOverflow
                            .ellipsis, // Teks jadi "..." jika kepanjangan
                      ),
                    ),
                  ],
                ),
              ...
              return DropdownMenuItem<String>(
                ...
                child: ConstrainedBox(
                  constraints: const BoxConstraints(
                    maxWidth: 180,
                  ), // Batasi lebar kotak popup
                  child: Text(
                    wallet['branches']?['nama_cabang'] ?? 'Cabang',
                    style: TextStyle(
                      fontWeight: wallet['id'] == activeWallet!['id']
                          ? FontWeight.w800
                          : FontWeight.w600,
                      color: wallet['id'] == activeWallet!['id']
            ...
            DropdownMenuItem<String>(
              ...
              child: ConstrainedBox(
                constraints: BoxConstraints(
                  maxWidth: 180,
                ), // Kunci lebar row agar tidak menabrak batas
                child: Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    Icon(
                    ...
                    SizedBox(width: 8),
                    Flexible(
                      // <--- Kunci Anti-Meleber untuk "Buka Cabang Lain"
                      child: Text(
                        'Buka Cabang Lain',
                        style: TextStyle(
                          color: Colors.green,
                                ...
                                children: [
                                  ...
                                  Container(
                                    ...
                                    child: Material(
                                      ...
                                      child: InkWell(
                                        borderRadius: BorderRadius.circular(20),
                                        // [FIX]: Jangan query ulang customer via profile_id,
                                        // karena Multi-Wallet artinya 1 profile_id bisa
                                        // punya lebih dari 1 baris di tabel customers.
                                        // .maybeSingle() akan melempar exception yang
                                        // tidak tertangkap saat baris > 1, sehingga
                                        // Navigator.push tidak pernah jalan (tap terlihat
                                        // tidak merespons). ID cabang aktif sudah ada di
                                        // activeWallet, jadi cukup pakai itu langsung.
                                        onTap: () {
                                        ...
                                        child: Column(
                                          children: [
                                            Icon(
                                              ...
                                              size: 48,
                                              color: CustomerTheme.textHint,
                                            ),
                                            SizedBox(height: 16),
                                            Text(
                                              'Belum ada cucian aktif',
                                              style: TextStyle(
                                            ...
                                            SizedBox(height: 4),
                                            Text(
                                              'Cucian Anda yang sedang diproses akan muncul di sini.',
  ...
  Future<void> _fetchCustomerIds() async {
    ...
    try {
      ...
      if (data.isNotEmpty && mounted) {
        setState(() {
          _customerIds = List<String>.from(data.map((e) => e['id']));
        });
      }
    } catch (e) {}
  }
      ...
      stream: Supabase.instance.client
          ...
          .map(
            (data) => data
                .where(
                  (n) =>
                      _customerIds.contains(n['customer_id']) &&
                      n['is_read'] == false,
                )
                .toList(),
          ),
        ...
        return Positioned(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: Colors.red,
              shape: BoxShape.circle,
              border: Border.all(color: CustomerTheme.surface, width: 2),
            ),
            child: Text(
